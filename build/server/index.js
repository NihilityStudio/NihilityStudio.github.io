import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/index-ce9e3047-8c7cf7dc.js';
...
const template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en" data-theme="" style="background:black">\n	<head>\n		<meta charset="utf-8" />\n		<title>The Real Windows XP Online - RebornXP</title>\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<link rel="stylesheet" id="theme" href=""/>\n		<meta name="viewport" content="width=device-width,initial-scale=1" />\n		<meta name="description" content="Experience the past with RebornXP, an online Windows XP simulator. Relive the nostalgia in your browser \u2013 faithful recreation of the iconic interface and features. Open-source and JavaScript-powered."/>\n		' + head + `
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-2R1EBBZX26"><\/script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-2R1EBBZX26');
<\/script>
	...
	<body>
		...
		<\/script>
<script type="text/javascript">var e=document.createElement("script");e.type="text/javascript",e.src="//optionsdisk.com/b6/a9/5d/b6a95dc2d8153ddb16d6d9930a6f0b9f.js",e.onload=function(){},document.body.appendChild(e);<\/script>
...
class Server {
  ...
  async respond(request, options = {}) {
    ...
    if (!this.options.hooks) {
      const module = await import('./chunks/hooks-680d2e13-66e5b99c.js');
      this.options.hooks = {
